...
<div class="dtree">
  ...
  <tr>
  	<td><a href="${pageContext.request.contextPath}/admin/orders/findOrderByManyCondition.do" target="mainFrame" class="left_list">订单管理</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/admin/notices/ListNoticeServlet.do" target="mainFrame" class="left_list">公告管理</a></td>
  </tr>
</table>
</body>
</html>
