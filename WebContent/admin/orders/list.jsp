...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/admin/orders/findOrderByManyCondition.do"
		method="post">
							...
							<c:forEach items="${orders}" var="order">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/admin/orders/findOrderById.do?id=${order.id}">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><c:if
											...
											<a
												href="${pageContext.request.contextPath}/admin/orders/delOrderById.do?id=${order.id}">
												<img
	  ...
	  <yyf:pager pageIndex="${requestScope.pageModel.pageIndex}" 
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/admin/orders/findOrderByManyCondition.do?pageIndex={0}"/>
	  	<%--  <fkjava:pager
